                        ...
                        <td>
                            <table style="text-align: center; background: #fff;padding:  25px 30px; width: 100%;">
                                ...
                                <tr>
                                    <td>
                                        <br> 
                                        <h5 style="font-size: 16px; margin-top: 0;">[Suborder id #{{ $result['getsalesdetailchild'][0]['suborder_id'] }}] ({{ date('F d,Y',strtotime($result['created_at'])) }})
                                        </h5>
                                ...
                                <tr>
                                    <td>
                                        <h6 style="margin: 0; color: #a6a6a6;font-size: 12px; font-weight: 500;">&copy;
                                            2021. Made by <a href="" style="color: #768d17;">Neelkanth Pharmacy</a></h6>
                                    </td>
                                </tr>
                            </table>
                        </td>

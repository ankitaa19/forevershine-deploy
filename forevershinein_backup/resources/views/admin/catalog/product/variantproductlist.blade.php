                                        ...
                                        <table class="table table-hover js-basic-example contact_list dataTable"
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="center sorting" tabindex="0"
                                                        aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                                                        style="width: 193.017px;"
                                                        aria-label=" Email : activate to sort column ascending">  Shipping Amount
                                                    </th>
													<th class="center sorting" tabindex="0"
                                                        aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                                                        style="width: 193.017px;"
												...
												@if(!empty($result))
													@foreach($result as $key=>$value)
														<tr class="gradeX odd">
															...
															<td class="center">{{ $value['shipping_amount'] }}</td>
															<td class="center">  
																@php
																	$attribute='';
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <th class="center" rowspan="1" colspan="1">  Shipping Amount </th>
